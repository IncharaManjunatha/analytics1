...
tweets <- userTimeline("IncharaKM", n=10)
tweets
...
n.tweet
tweets.df <- twListToDF(tweets)  #list of objects from a single twitteR class and return a data.frame version of the members
head(tweets.df)
summary(tweets.df)
